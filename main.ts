...
document.addEventListener("DOMContentLoaded", () => {
  ...
  generateBtn.addEventListener("click", (event) => {
    ...
    const name = (document.querySelector("#name") as HTMLInputElement).value;
    const email = (document.querySelector("#email") as HTMLInputElement).value;
    const about = (document.querySelector("#about") as HTMLTextAreaElement)
      .value;
    const Company = (document.querySelector("#company") as HTMLInputElement)
      .value;
    const joinDate = (document.querySelector("#joinDate") as HTMLInputElement)
      .value;
    ...
    const education = (document.querySelector("#education") as HTMLInputElement)
      .value;
    const eduJoin = (document.querySelector("#eduJoin") as HTMLInputElement)
      .value;
    const eduEnd = (document.querySelector("#eduEnd") as HTMLInputElement)
      .value;
